...
export class SessionMonitor {
    ...
    get _propagateUserSessionError() {
        return this._settings.propagateUserSessionError;
    }
            ...
            if (!this._checkSessionIFrame) {
                this._metadataService.getCheckSessionIframe().then(url => {
                    if (url) {
                        ...
                        const propagateUserSessionError = this._propagateUserSessionError;
                        ...
                        this._checkSessionIFrame = new this._CheckSessionIFrameCtor(
                            ...
                            this._triggerUserSessionErrorPropagation.bind(this)
                        );
    ...
    _triggerUserSessionErrorPropagation() {
        this._userManager.events._raiseUserSessionError();
    }
